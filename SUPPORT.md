# Support 
Abide Together — Support Thanks for using Abide Together! If you need help, have questions, or want to report a problem, you can reach us anytime.

Contact Support If you experience issues or need assistance, please email:

abidetogether.help@gmail.com

We will try to get back with you within 3-5 business days.

Report a Bug - When reporting a bug, please include (if possible): Device model (e.g., iPhone 12, iPad Air) iOS version Steps to reproduce the issue Screenshots (optional but helpful) This allows us to fix things as quickly as possible.
